    ...
    >
      <div class="vhd-calendar">
        <div class="vhd-calendar-header">
          ...
          <span class="info">
            ...
            <span
              v-if="selectStartDate"
              class="from-date"
            > {{ displayDateText(selectStartDate) }} </span>
            <span
              v-if="selectEndDate"
              class="to-text"
            >{{ toText }}</span>
            <span
              v-if="selectEndDate"
              class="from-date"
            > {{ displayDateText(selectEndDate) }} </span>
          </span>
        </div>
        ...
        <div class="vhd-calendar-right">
          ...
          <div class="calendar-date">
            <div
              v-for="(week, wIndex) in endMonthAry"
              :key="wIndex"
              class="week"
            >
              <div
    ...
    disabledPreviousArrow(datetime) {
      ...
      if (datetime && this.selectForward) {
        if (this.selectMinDate && this.selectStartDate) {
          ...
          if (
            datetime.getFullYear() < minimalTime.getFullYear() ||
            datetime.getMonth() <= minimalTime.getMonth()
          ) {
            return 'disabled';
          }
